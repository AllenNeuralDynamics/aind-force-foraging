...
class AindRigDataMapper(ads.AindDataSchemaRigDataMapper):
    """Outputs a data mapper for aind-data-schema Rig. By default, it will go in
    the directory `{db_root}/{_DATABASE_DIR}/{computer_name}/{rig_schema_file_name}.json`"""
...
class AindSessionDataMapper(ads.AindDataSchemaSessionDataMapper):
    def __init__(
        ...
        rig_model: AindForceForagingRig,
        task_logic_model: AindForceForagingTaskLogic,
    ...
    def _map(
        ...
        **kwargs,
        ...
        stimulation_parameters: List[aind_data_schema.core.session.AuditoryStimulation] = []
        ...
        # Mouse platform
        mouse_platform: str = "force-foraging-buttons"
...
def aind_rig_data_mapper_factory(
    launcher: BehaviorLauncher[AindForceForagingRig, AindBehaviorSessionModel, AindForceForagingTaskLogic],
) -> AindRigDataMapper:
    rig_schema: AindForceForagingRig = launcher.rig_schema
