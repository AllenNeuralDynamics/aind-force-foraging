...
def main():
    models = {
        "aind_vr_foraging_task": aind_behavior_force_foraging.task_logic.schema(),
        "aind_vr_foraging_session": aind_behavior_force_foraging.session.schema(),
        "aind_vr_foraging_rig": aind_behavior_force_foraging.rig.schema(),
    }
