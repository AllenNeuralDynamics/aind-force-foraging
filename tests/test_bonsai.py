...
class BonsaiTests(unittest.TestCase):
    def test_deserialization(self):
        ...
        models_to_test = [
            ...
            TestModel(bonsai_property="RigPath", json_root=JSON_ROOT, model=AindForceForagingRig),
            TestModel(bonsai_property="TaskLogicPath", json_root=JSON_ROOT, model=AindForceForagingTaskLogic),
        ]
